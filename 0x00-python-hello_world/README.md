...
6. [Play with strings](6-concat.py) : Complete this source code to print `Welcome to School!`
	- You can find the source code [here](https://github.com/Alx_Africa/0x00.py/blob/master/6-concat.py)
